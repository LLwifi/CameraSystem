...
public:
	...
	*/
	...
	void PushCameraEvent(const UObject* WorldContextObject, FCS_CameraEventHandle CameraEventHandle, FCS_PushCameraEventInfo PushCameraEventInfo, APlayerController* TriggerPlayerController, TArray<UCS_CameraModifier*>& CameraModifier_Post, TArray<UCameraShakeBase*>& CameraShake);
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject"))
	void TriggerCameraEvent(const UObject* WorldContextObject, FCS_CameraEventHandle CameraEventHandle, FVector TriggerLocation, FCS_TriggerCameraEventInfo TriggerCameraEventInfo, TArray<UCS_CameraModifier*>& CameraModifier_Post);
